...
public class GetRecommendationsTest {
    ...
    public static void getRecomendationsPanelByTrack(String token) {
        ...
        User user = new User(user_token);
        Statify.setUser(user);
        HashMap<String, String> recommendations = user.getRecomendationsByTopTracks("short_term");
        JScrollPane scrollPane = Statify.createRecommendationsPanel(recommendations);
